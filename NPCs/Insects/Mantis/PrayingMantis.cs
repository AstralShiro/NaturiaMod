...
namespace Naturia.NPCs.Insects.Mantis
{
	/// <summary>
	...
	/// </summary>
	internal class PrayingMantisNPC : ModNPC
	{
		...
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Praying Mantis");
		...
		public override void SetDefaults() {
			...
			npc.catchItem = (short)ModContent.ItemType<PrayingMantisItem>();
		...
		public override void HitEffect(int hitDirection, double damage) {
			if (npc.life <= 0) {
				...
				Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gores/MantisGore1"), npc.scale);
				Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gores/MantisGore2"), npc.scale);
			}
		}
	...
	internal class PrayingMantisItem : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Praying Mantis");
		}
		...
		public override void SetDefaults() {
			...
			item.bait = 5;
			item.makeNPC = (short)ModContent.NPCType<PrayingMantisNPC>();
		}
	}
}
